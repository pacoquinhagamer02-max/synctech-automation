# Textos prontos para enviar a clientes/prospects — SyncTech Automation

> Textos de copy prontos pra copiar e colar (WhatsApp, formatação com `*negrito*`).
> Complementa [vendas-prospeccao.md](vendas-prospeccao.md) (que cobre o processo/script/objeções) —
> aqui é o conteúdo final já escrito. Gerados em 03/09/2026.

## 1. CTA curto — primeira abordagem fria

Usado no botão de WhatsApp do Pipeline (`app/index.html`, mensagem gerada automaticamente por lead).

```
Oi! Vi o [nome do negócio] aqui em [cidade]. Ajudei uma barbearia em Mariana a
crescer 18% em agendamentos sem gastar mais com anúncio — usando automação de
WhatsApp e Instagram. Posso te mostrar como funcionaria pro seu negócio? Leva
5 minutos.
```
...
```
*SyncTech Automation* 🤖
_Automação completa pro seu negócio local — sem complicação_

Você já perdeu cliente por demorar a responder o WhatsApp? Já teve gente
desistindo de agendar porque só dava pra marcar por ligação? Isso é dinheiro
...
compromisso — já te mostro na prática.*

━━━━━━━━━━━━━━━
*O QUE CADA FERRAMENTA FAZ POR VOCÊ*
━━━━━━━━━━━━━━━

*1. Atendimento que nunca dorme*

💬 *WhatsApp Bot 24/7* — Responde, agenda e tira dúvida na hora, inclusive de
madrugada. Menos cliente desistindo por demora.

📸 *Instagram Automático* — Comentário ou DM viram resposta automática que
direciona pro WhatsApp. Curtida vira conversa de venda sozinha.

💭 *Chat ao Vivo no Site* — Visitante tira dúvida sem sair da página, em vez
de sair procurando seu WhatsApp e esquecer de voltar.

*2. Vender e agendar sem esforço*

📅 *Agendamento Online* — Cliente escolhe dia e horário sozinho, sem trocar
10 mensagens. Funciona 24h.

🔗 *Link na Bio* — Uma página com tudo: contato, serviços, botão de agendar.
Cliente entende em 10 segundos.

🛍️ *Catálogo Digital* — Preços organizados, sem mandar foto por foto toda
vez que perguntam "quanto custa".

*3. Organização e crescimento*

📋 *CRM com Pipeline* — Mostra onde cada lead está (contato, orçamento,
fechado), em vez de confiar na memória.

📊 *Dashboard de Métricas* — Faturamento e retorno de cliente num só lugar —
decisão com dado, não achismo.

⭐ *Gestão de Reputação* — Cliente satisfeito vai pro Google, insatisfeito
manda feedback privado. Protege sua nota.

✉️ *Email Marketing* — Mantém contato com quem já foi cliente, pra ele
voltar.

📈 *Tráfego Pago (Meta Ads)* — Coloca seu negócio na frente de quem ainda
não te conhece na região, com gestão profissional.

Não precisa usar tudo de uma vez — cada ferramenta já ajuda sozinha, e dá
pra ir somando conforme o negócio cresce.
...
_Serviços avulsos, sem entrar num plano fechado_
━━━━━━━━━━━━━━━
• WhatsApp Bot 24/7 — R$147/mês
• Instagram Automático — R$127/mês
• Agendamento Online — R$97/mês
• CRM com Pipeline — R$127/mês
• Dashboard de Métricas — R$127/mês
• Gestão de Reputação (Google) — R$97/mês
• Catálogo Digital — R$67/mês
...
━━━━━━━━━━━━━━━
Se seu negócio precisa de algo mais específico — um CRM próprio, painel
financeiro, app de fidelidade, ferramenta interna — desenvolvo personalizado
pra você, fora do pacote padrão. Valor a partir de *R$990* (setup único),
variando com a complexidade.

━━━━━━━━━━━━━━━

*Bora automatizar seu atendimento?* Me manda uma mensagem contando como
funciona seu dia a dia hoje (WhatsApp, agenda, Instagram) que eu já te digo
na hora qual opção — plano, avulso ou personalizado — encaixa melhor no seu
negócio. 5 minutos, sem compromisso.
```

## Notas de precificação

- Preços dos planos batem com `index.html` (landing) e `app/index.html` → `PLANS` (aba Config → Nossos Planos) — mesma fonte de verdade, não duplicar com número diferente se algum dia mudar o preço.
- Preços avulsos foram calculados proporcionalmente ao valor dos planos fechados (avulso sempre um pouco mais caro por item do que dividir o plano fechado, pra incentivar o pacote) — não vêm de nenhuma pesquisa de mercado específica, são estimativa própria.
- "App sob medida a partir de R$990" — também estimativa própria (não pesquisa de mercado), baseada no fato de já ter entregue um pacote de 4 ferramentas personalizadas (CRM, avaliação, dashboard, fidelidade) pra Martins sem cobrar à parte — serviria de piso pro que já foi entregue de graça até aqui.
